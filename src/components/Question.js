...
const ProgressBar = props => {
    ...
    const percent = ((optionOneVotes/totalVotes)*100).toFixed(2)
    return (
    ...
    render () {
        ...
        return(
            <div className='user-info'>
                ...
                {idFromParams === true && hasAnswered === false && (
                    <div className='question-unanswered'>
                        ...
                        <div>
                            ...
                            <form onSubmit={this.onSubmit}>
                                <PollOptionRadioInputItem value="optionOne" checked={this.state.selectedOption === "optionOne"} onChange={this.onChange}>
                                {optionOne.text}
                                </PollOptionRadioInputItem>
                                <PollOptionRadioInputItem value="optionTwo" checked={this.state.selectedOption === "optionTwo"} onChange={this.onChange}>
                                {optionTwo.text}
                                </PollOptionRadioInputItem>
                ...
                {idFromParams === true && hasAnswered === true && (
                    <div className='question-answered'>
                        ...
                        <div>
                            ...
                            <ProgressBar optionOneVotes={optionOne.votes} optionTwoVotes={optionTwo.votes}/>
